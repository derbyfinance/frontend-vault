...
import { StyledArrowDown, StyledCircle, StyledDescription, StyledIcon, StyledInfoBlockWrapper, StyledNetworkIcon, StyledNetworkInfo, StyledNetworkInfoSection, StyledNetworkTitle, StyledTitle, StyledValue, StyledValuePart, SyledHeroWrapper } from './styled';
  ...
  return (
    <SyledHeroWrapper>
      ...
      <StyledNetworkInfoSection>
        ...
        <StyledNetworkInfo>
          <NetworkInfoBlock icon={totalValueSVG} value={totalValue} description="TOTAL VALUE LOCKED"/>
          <NetworkInfoBlock icon={vaultsSVG} value={vaults} description="VAULTS"/>
          <NetworkInfoBlock icon={membersSVG} value={members} description="MEMBERS"/>
        </StyledNetworkInfo>
      </StyledNetworkInfoSection>
      <StyledNetworkIcon>
        <Image src={ethereumBigSVG} />
      </StyledNetworkIcon>
    </SyledHeroWrapper>
  )
}
